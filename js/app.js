...
App.prototype.renderCats = function(){
  var html = '<h2>Feeds:</h2><div class="panel-group">';
  var appSources = this.sources;
  //console.log(this.categories);
  this.categories.forEach(function(category){
    html += '<div class="panel panel-default">';
    html += '<div class="panel-heading">';
    html += '<h4 class="panel-title">';
    html += '<a data-toggle="collapse" href="#collapse-' + category.id + '">' + category.name + '</a></h4></div>';
    html += '<div id="collapse-' + category.id + '" class="panel-collapse collapse"><div class="panel-body"><ul id="feed-list-' + category.name + '">';
...
App.prototype.renderArticle = function(id, article){
